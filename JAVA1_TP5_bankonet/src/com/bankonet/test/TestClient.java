...
public class TestClient {
	 ...
	 public static void main(String[] args) {
		...
		Compte cD = listClient.get(1).getCompte(2);
		Compte cC = listClient.get(0).getCompte(1);
		try {
			cD.effectuerVirement(cC, 100f);
		} catch (DebitException | BankonetException | CreditException e) {
